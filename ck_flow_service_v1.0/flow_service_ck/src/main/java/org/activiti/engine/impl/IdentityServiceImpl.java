...
import org.activiti.engine.impl.cmd.CreateIdentityLinkEntityCmd;
...
public class IdentityServiceImpl extends ServiceImpl implements IdentityService {
   ...
   * @return
   */
  public void save(IdentityLinkEntity identityLinkEntity){
	  commandExecutor.execute(new CreateIdentityLinkEntityCmd(identityLinkEntity));
