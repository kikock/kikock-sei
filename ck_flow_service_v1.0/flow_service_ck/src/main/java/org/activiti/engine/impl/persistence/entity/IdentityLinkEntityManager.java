 ...
 */
//  @SuppressWarnings("unchecked")
//  public IdentityLinkEntity findIdentityLink(String id) {
//    return getDbSqlSession().selectById(entityClass, id)("selectIdentityLink",id);
//  }
//  
  public IdentityLinkEntity findIdentityLinkById(String id) {
	    if (id == null) {
	      throw new ActivitiIllegalArgumentException("Invalid IdentityLinkEntity id : null");
	    }
	    return (IdentityLinkEntity) getDbSqlSession().selectById(IdentityLinkEntity.class, id);
	  }
