...
@Entity()
@Table(name = "default_business_model3")
@DynamicInsert
@DynamicUpdate
@BusinessEntityAnnotaion(conditionBean="com.kcmp.ck.flow.vo.conditon.DefaultBusinessModel3Condition",daoBean="defaultBusinessModel3Dao")
public class DefaultBusinessModel3 extends AbstractBusinessModel implements ITenant {
    /**
     * 单价
     */
