...
public abstract class JsonUtils {
     ...
     * 将json通过类型转换成对象
     * <pre>
     *     {@link com.kcmp.ck.config.util.JsonUtils JsonUtil}.fromJson("{\"username\":\"username\", \"password\":\"password\"}", User.class);
     * </pre>
     *
     * @param <T>   泛型
     * @param json  json字符串
    ...
    //     * 将json通过类型转换成集合对象
    //     * <pre>
    //     *     {@link com.kcmp.ck.config.util.JsonUtils JsonUtil}.fromJson("[{\"username\":\"username\", \"password\":\"password\"}, {\"username\":\"username\", \"password\":\"password\"}]", new TypeReference&lt;List&lt;User&gt;&gt;);
    //     * </pre>
    //     *
    //     * @param <T>           泛型
    //     * @param json          json字符串
     ...
     * 将对象转换成json
     * <pre>
     *     {@link com.kcmp.ck.config.util.JsonUtils JsonUtil}.toJson(user);
     * </pre>
     *
     * @param <T> 泛型
     * @param src 对象
     ...
     * 将对象转换成json, 可以设置输出属性
     * <pre>
     *     {@link com.kcmp.ck.config.util.JsonUtils JsonUtil}.toJson(user, {@link JsonInclude Inclusion.ALWAYS});
     * </pre>
     ...
     *     mapper.configure({@link DeserializationFeature FAIL_ON_NUMBERS_FOR_ENUMS}, true);
     *     mapper.setDateFormat(new {@link SimpleDateFormat SimpleDateFormat}("yyyy-MM-dd HH:mm:ss"));
     *     {@link com.kcmp.ck.config.util.JsonUtils JsonUtil}.toJson(user, mapper);
     * </pre>
